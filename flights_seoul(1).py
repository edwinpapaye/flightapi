...
if(os.path.isfile('/content/sample_data/airlinesPrices.csv')):
    airlinesDataFrame.to_csv('/content/sample_data/airlinesPrices.csv',  header=False, mode='a')
else:
   airlinesDataFrame.to_csv('/content/sample_data/airlinesPrices.csv')

imagesrc =f"/content/sample_data/{datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S')}_airlinesPrices.png"
plt.rcParams["figure.figsize"] = [10, 5]
plt.rcParams["figure.autolayout"] = True
columns = ["Timestamp", "Airline", "Price"]
df = pd.read_csv("/content/sample_data/airlinesPrices.csv", usecols=columns)
grouped_airlines = df.groupby(['Airline'])

for airline, rows in grouped_airlines:
  plt.plot(rows["Timestamp"], rows["Price"], label = airline)
...
<!--<![endif]-->
    <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fbfbfb;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
      ...
      <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
        <h1 class="size-22" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #565656;font-size: 18px;line-height: 26px;font-family: Ubuntu,sans-serif;" lang="x-size-22"><span class="font-ubuntu" style="text-decoration: inherit;"><span style="text-decoration: inherit;">Bien le bonjour Rapha&#235;l,</span></span></h1><p style="Margin-top: 20px;Margin-bottom: 0;font-family: Ubuntu,sans-serif;"><span class="font-ubuntu" style="text-decoration: inherit;"><span style="text-decoration: inherit;">Comme d'habitude, voici ton rapport r&#233;gulier concernant le prix des vols pour partir avec nous &#224; S&#233;oul. On t'aime </span></span></p><h2 class="size-17" style="Margin-top: 20px;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #555;font-size: 17px;line-height: 26px;font-family: Ubuntu,sans-serif;" lang="x-size-17"><span class="font-ubuntu" style="text-decoration: inherit;"><span style="text-decoration: inherit;">Informations du Voyage:</span></span></h2><ul style="Margin-top: 16px;Margin-bottom: 0;Margin-left: 24px;padding: 0;list-style-type: disc;"><li style="Margin-top: 16px;Margin-bottom: 0;Margin-left: 0;font-family: Ubuntu,sans-serif;"><span class="font-ubuntu" style="text-decoration: inherit;"><span style="text-decoration: inherit;">A&#233;roport de d&#233;part: GVA</span></span></li><li style="Margin-top: 0;Margin-bottom: 0;Margin-left: 0;font-family: Ubuntu,sans-serif;"><span class="font-ubuntu" style="text-decoration: inherit;"><span style="text-decoration: inherit;">A&#233;roport d'arriv&#233;e: ICN</span></span></li><li style="Margin-top: 0;Margin-bottom: 0;Margin-left: 0;font-family: Ubuntu,sans-serif;"><span class="font-ubuntu" style="text-decoration: inherit;"><span style="text-decoration: inherit;">Date de 
d&#233;part: 2022-03-23</span></span></li><li style="Margin-top: 0;Margin-bottom: 0;Margin-left: 0;font-family: Ubuntu,sans-serif;"><span class="font-ubuntu" style="text-decoration: inherit;"><span style="text-decoration: inherit;">Date d'arriv&#233;e: 2022-04-21</span></span></li></ul><h2 class="size-17" style="Margin-top: 20px;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #555;font-size: 17px;line-height: 26px;font-family: Ubuntu,sans-serif;" lang="x-size-17"><span class="font-ubuntu" style="text-decoration: inherit;"><span style="text-decoration: inherit;">Prix actuel du vol Etihad:</span></span></h2><p style="Margin-top: 16px;Margin-bottom: 0;">&nbsp;</p><p class="size-36" style="mso-text-raise: 14px;Margin-top: 20px;Margin-bottom: 0;font-family: Ubuntu,sans-serif;font-size: 30px;line-height: 38px;text-align: center;" lang="x-size-36"><span class="font-ubuntu" style="text-decoration: inherit;"><span style="text-decoration: inherit;"><strong>"""+str(minimumfare)+"""CHF</strong></span></span></p><p class="size-17" style="Margin-top: 20px;Margin-bottom: 0;font-family: Ubuntu,sans-serif;font-size: 17px;line-height: 26px;text-align: center;" lang="x-size-17"><span class="font-ubuntu" style="text-decoration: inherit;"><span style="text-decoration: inherit;">&nbsp;</span></span></p><p class="size-17" style="Margin-top: 20px;Margin-bottom: 0;font-family: Ubuntu,sans-serif;font-size: 17px;line-height: 26px;text-align: left;" lang="x-size-17"><span class="font-ubuntu" style="text-decoration: inherit;"><span style="text-decoration: inherit;">&#201;volution par rapport au pr&#233;c&#233;dent rapport:</span></span></p><h2 class="size-64" style="mso-text-raise: 25px;Margin-top: 20px;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #555;font-size: 
44px;line-height: 50px;font-family: Times,Times New Roman,serif;text-align: center;" lang="x-size-64"><span class="font-times" style="text-decoration: inherit;"><span style="text-decoration: inherit;"><span style="text-decoration: inherit;color: #f70019;">&#8599;</span></span></span></h2><h2 class="size-17" style="Margin-top: 16px;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #555;font-size: 17px;line-height: 26px;font-family: Ubuntu,sans-serif;" lang="x-size-17"><span class="font-ubuntu" style="text-decoration: inherit;"><span style="text-decoration: inherit;">&#201;volution du prix de la concurrence:</span></span></h2><p style="Margin-top: 16px;Margin-bottom: 20px;">&nbsp;</p>
      </div>
    </div>
        
        <div style="font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;" align="center">
          <img class="gnd-corner-image gnd-corner-image-center gnd-corner-image-bottom" style="border: 0;display: block;height: auto;width: 100%;max-width: 720px;" alt="" width="600" src="cid:image1" />
        </div>
        ...
        <div class="layout email-footer stack" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
          ...
          <!--[if (mso)|(IE)]></td><td style="width: 200px;" valign="top" class="w160"><![endif]-->
            <div class="column narrow" style="text-align: left;font-size: 12px;line-height: 19px;color: #999;font-family: Georgia,serif;Float: left;max-width: 320px;min-width: 200px; width: 320px;width: calc(72200px - 12000%);">
              <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                <div class="footer__share-button" emb-if-social="fblike || tweet || linkedinshare || forwardtoafriend">
                  <div style="Margin-bottom: 6px;mso-line-height-rule: exactly;" emb-if-social="fblike">
                    <fblike style="border-radius: 2px;color: #ffffff;display: inline-block;font-size: 11px;font-weight: bold;line-height: 19px;text-align: left;text-decoration: none;border-style: solid;border-width: 4px 7px 3px 4px;mso-border-width-alt: 4px 8px 8px 8px;background-color: #7e7e7e;border-color: #7e7e7e;mso-border-color-alt: #7e7e7e;" emb-social="fblike">
                  ...
                  <div style="Margin-bottom: 6px;mso-line-height-rule: exactly;" emb-if-social="tweet">
                  ...
                  <div style="Margin-bottom: 6px;mso-line-height-rule: exactly;" emb-if-social="linkedinshare">
                    <linkedinshare style="border-radius: 2px;color: #ffffff;display: inline-block;font-size: 11px;font-weight: bold;line-height: 19px;text-align: left;text-decoration: none;border-style: solid;border-width: 4px 7px 3px 4px;mso-border-width-alt: 4px 8px 8px 8px;background-color: #7e7e7e;border-color: #7e7e7e;mso-border-color-alt: #7e7e7e;" emb-social="linkedinshare">
                  ...
                  <div style="Margin-bottom: 6px;mso-line-height-rule: exactly;" emb-if-social="forwardtoafriend">
                    <forwardtoafriend style="border-radius: 2px;color: #ffffff;display: inline-block;font-size: 11px;font-weight: bold;line-height: 19px;text-align: left;text-decoration: none;border-style: solid;border-width: 4px 7px 3px 4px;mso-border-width-alt: 4px 8px 8px 8px;background-color: #7e7e7e;border-color: #7e7e7e;mso-border-color-alt: #7e7e7e;" emb-social="forwardtoafriend" lang="en">
            ...
            <div class="column" style="text-align: left;font-size: 12px;line-height: 19px;color: #999;font-family: Georgia,serif;">
              <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                <div style="font-size: 12px;line-height: 19px;margin-bottom: 15px;">
                  <span emb-social="preferences"><preferences style="text-decoration: underline;" lang="en">Preferences</preferences>&nbsp;&nbsp;|&nbsp;&nbsp;</span><unsubscribe style="text-decoration: underline;">Unsubscribe</unsubscribe>
                </div>
              </div>
            </div>
          <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
